...
extern unsigned int const C_badge_back_colors[];
extern unsigned char const C_badge_back_bitmap[];
#ifdef OS_IO_SEPROXYHAL
        #include "os_io_seproxyhal.h"
        extern const bagl_icon_details_t C_badge_back;
...
extern unsigned char const C_icon_left_bitmap[];
        ...
        #endif // OS_IO_SEPROXYHAL
#ifndef GLYPH_icon_monero_BPP
        #define GLYPH_icon_monero_WIDTH 14
        #define GLYPH_icon_monero_HEIGHT 14
        #define GLYPH_icon_monero_BPP 1
extern unsigned int const C_icon_monero_colors[];
extern unsigned char const C_icon_monero_bitmap[];
#ifdef OS_IO_SEPROXYHAL
        #include "os_io_seproxyhal.h"
        extern const bagl_icon_details_t C_icon_monero;
        #endif // GLYPH_icon_monero_BPP
        #endif // OS_IO_SEPROXYHAL
